...
> Note : #427 a ete absorbee dans la vague 3 avec #462. Ce fichier est une copie de
> `issue-462-done.md` pour que la garde de completude du sprint trouve une entree par issue.
